...
const CreateParentProjectModal: React.FC<Props> = ({ open, onClose, onProjectCreated }) => {
  ...
  const handleSubmit = async () => {
    ...
    if (!trimmedName || !trimmedDescription) { setError('All fields are required'); return;}

    if (!userId) { setError('User authentication required'); return;}
...
export default CreateParentProjectModal;